...
<div class="pos-f-t">
    <div class="collapse" id="navbarToggleExternalContent">
        <div class="bg-dark p-4">
            <ul class="">
                <li th:if="${userRole.equals('ADMIN')}">
                ...
                <li th:if="${userRole.equals('SELLER')}">
                    <a href="/admin/order/list">order</a>
                </li>
                <li th:if="${userRole.equals('SUPER_ADMIN')}">
        ...
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tr th:each="category: ${categoryList}">
                    ...
                    <td th:text="${category.parentId}"/>
                    <td>
                        <a href="#editEmployeeModal"  class="edit" data-toggle="modal">
                            <i class="material-icons" data-toggle="tooltip"  title="Edit">&#xE254;</i></a>
                        <a th:href="@{/admin/category/delete/{id}(id=${category.id})}" class="delete" data-toggle="modal">
            ...
            <form  action="/admin/category/add">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="btn-group" required name="parentName">
                            <option>0</option>
                            <option th:each="category : ${categoryList}"
                                    th:text="${category.parentId}"/>
                        </select>
                    </div>
                </div>
        ...
        <div class="modal-content">
            <form method="post"  action="/admin/category/update/">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Parent Name</label>
                        <input type="text" class="form-control" required name="parentName">
                    </div>
                </div>
                <div class="modal-footer">
                    <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
