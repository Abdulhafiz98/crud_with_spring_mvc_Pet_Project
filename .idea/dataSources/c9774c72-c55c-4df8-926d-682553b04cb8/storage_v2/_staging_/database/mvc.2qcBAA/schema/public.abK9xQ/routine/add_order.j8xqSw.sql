...
BEGIN
    ...
    delete from basket where userid = v_chat_id and productid = v_pro_id;
    return true;
end
$$;

select * from add_order(i_user := 378400797, i_product := 'Samsung Note 21 Ultra');
select * from add_order(i_user := 378400797, i_product := 'Samsung Note 9 Ultra');
